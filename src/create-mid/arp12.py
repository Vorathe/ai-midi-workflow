...
seductive_arp_synth_pitch_duration_data = [
  # Bar 1 - 4
  (60, 0.5), (63, 0.5), (65, 0.5), (63, 0.5), (62, 0.5), (60, 0.5), (58, 0.5), (60, 0.5),  # C4, D#4, F4, D#4, D4, C4, A#3, C4
  (60, 0.5), (63, 0.5), (65, 0.5), (63, 0.5), (62, 0.5), (60, 0.5), (58, 0.5), (60, 0.5),  # C4, D#4, F4, D#4, D4, C4, A#3, C4
  (60, 0.5), (63, 0.5), (65, 0.5), (63, 0.5), (62, 0.5), (60, 0.5), (58, 0.5), (60, 0.5),  # C4, D#4, F4, D#4, D4, C4, A#3, C4
  (60, 0.5), (63, 0.5), (65, 0.5), (63, 0.5), (62, 0.5), (60, 0.5), (58, 0.5), (60, 0.5),  # C4, D#4, F4, D#4, D4, C4, A#3, C4

  # Bar 5 - 8
  (60, 0.5), (63, 0.5), (67, 0.5), (70, 0.5), (67, 0.5), (63, 0.5), (62, 0.5), (58, 0.5),  # C4, D#4, G4, A#4, G4, D#4, D4, A#3
  (60, 0.5), (63, 0.5), (67, 0.5), (70, 0.5), (67, 0.5), (63, 0.5), (62, 0.5), (58, 0.5),  # C4, D#4, G4, A#4, G4, D#4, D4, A#3
  (60, 0.5), (63, 0.5), (67, 0.5), (70, 0.5), (67, 0.5), (63, 0.5), (62, 0.5), (58, 0.5),  # C4, D#4, G4, A#4, G4, D#4, D4, A#3
  (60, 0.5), (63, 0.5), (67, 0.5), (70, 0.5), (67, 0.5), (63, 0.5), (62, 0.5), (58, 0.5),  # C4, D#4, G4, A#4, G4, D#4, D4, A#3
]
